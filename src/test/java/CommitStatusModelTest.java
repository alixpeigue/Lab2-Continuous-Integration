...
public class CommitStatusModelTest {
    ...
    public void testCommitStatusSerialization() throws Exception {
        ...
        CommitStatusModel.CommitStatus commitStatus = new CommitStatusModel.CommitStatus(
                "success",
    ...
    public void deserializeNoError() throws IOException {
        ...
        CommitStatusModel.CommitStatus commitStatus = new ObjectMapper().readValue(json, CommitStatusModel.CommitStatus.class);
